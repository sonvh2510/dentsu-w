...
var MoveElement = /*#__PURE__*/function () {
  function MoveElement(selector) {
    ...
    try {
      ...
      this.screenListender = window.matchMedia("(min-width: ".concat(this.breakpoint, "px)"));
      this.init();
    } catch (error) {
      throw error;
    }
  ...
  _createClass(MoveElement, [{
    key: "dispatch",
    value: function dispatch(name, _ref) {
      var node = _ref.node,
          target = _ref.target;
      var fnc = MoveElement.Actions[name];
      return fnc(node, target);
    }
  }, {
    key: "move",
    value: function move(method, target) {
    ...
    key: "screenResizeHandler",
    value: function screenResizeHandler(screenListender) {
      var screen = screenListender.matches ? 'desktop' : 'mobile';
    ...
    value: function init() {
      ...
      this.screenListender.addEventListener('change', function () {
        _this.screenResizeHandler(_this.screenListender);
      });
    }
  }]);
...
_defineProperty(MoveElement, "Actions", {
  ...
  appendTo: function appendTo(node, target) {
    target.appendChild(node);
  },
  prependTo: function prependTo(node, target) {
    target.prepend(node);
  }
});
...
var Parallax = /*#__PURE__*/function () {
  function Parallax(selector) {
    ...
    if (document.querySelector(selector)) {
      ...
      this.documentHeight = document.body.clientHeight; // Initialize
  ...
  _createClass(Parallax, [{
    ...
    value: function scrollHandler() {
      ...
      var _this$options = this.options,
          ratio = _this$options.ratio,
          offset = _this$options.offset;
      this.target.style.backgroundPosition = "center ".concat(offset + -scrolled / ratio, "px"); // this.target.setAttribute(
      // 	'style',
...
var _move = _interopRequireDefault(require("./libs/move"));

var _parallax = require("./libs/parallax");
...
var headerToggle = document.querySelector('.js-header__toggle');
var headerClose = document.querySelector('.js-header__close');
var wrapper = document.querySelector('.header__siteMenu--hidden');
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  new _parallax.Parallax('.parallax', {
    target: '.parllax__img',
    ratio: 5,
    mobile: false,
    breakpoint: 1025,
  ...
  new _swiper.default('.what-we-do-2 .swiper-container', {
    centeredSlides: true,
    loop: true,
    speed: 1000,
    slidesPerView: 1.5,
  ...
  $('#scroll-to-service').on('click', function (e) {
    e.preventDefault();
    var position = $('#our-services').offset().top;
    $('html,body').animate({
      scrollTop: position - headerHeight
    }, 1000);
  }); // headerSiteMenuScrollbar();

  toggleHeader(); // Call fancybox
  ...
  $('[data-fancybox]').on('click', function (e) {
    e.preventDefault();
    var content = $(this).find('.celeb-dialog');
...
},{"./libs/move":1,"./libs/parallax":2,"perfect-scrollbar":5,"swiper":95}],4:[function(require,module,exports){
/**
 * Dom7 3.0.0
...
},{"ssr-window":6}],5:[function(require,module,exports){
/*!
...
},{"../../../utils/utils":94,"ssr-window":6}],69:[function(require,module,exports){
"use strict";
...
var _default = _dom.$;
exports.default = _default;
},{"dom7":4}],91:[function(require,module,exports){
"use strict";
