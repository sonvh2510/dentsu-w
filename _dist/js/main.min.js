...
document.addEventListener('DOMContentLoaded', function () {
  ...
  var checkLocalStorage = Boolean(localStorage.getItem('scrollToService'));
  ...
  $('#link-service').on('click', function (e) {
    ...
    if ($('#our-services').length > 0) {
      ...
      var url = "".concat(window.location.origin);
...
},{"./libs/move":1,"./libs/parallax":2,"swiper":94}],4:[function(require,module,exports){
/**
 * Dom7 3.0.0
...
var _default = _dom.$;
exports.default = _default;
},{"dom7":4}],90:[function(require,module,exports){
"use strict";
